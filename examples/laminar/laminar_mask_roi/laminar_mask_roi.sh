...
cp -ra $LAMINAR_DATA/rois/* /scratch/$USER/$SUBJ/$PROJNAME/data/
...
rsync -ra /scratch/$USER/$SUBJ/$PROJNAME/nighres/corticaldepth* $OUTPUT/
rsync -ra /scratch/$USER/$SUBJ/$PROJNAME/nighres/depth_and_data* $OUTPUT/
rsync -ra /scratch/$USER/$SUBJ/$PROJNAME/nighres/sanitycheck* $OUTPUT/
